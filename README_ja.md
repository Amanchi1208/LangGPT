...
- **[決策チェーン](Docs/决策链.md)** — システムダイナミクス、反転思考、ベイズ更新、OODA、二次思考、期待値思考を連結する六段階の意思決定チェーン
- **[Prompt 形式論：文質彬彬](Docs/Prompt形式论-文质彬彬.md)** — まず構造を用意して内容を詰めるのではなく、内容を自然に展開させてから構造をそれに沿わせ、形式そのものを思考の形にする
